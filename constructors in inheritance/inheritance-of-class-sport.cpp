// Extend the program of class student with inhertance to include a class sports, which stores 
// the sports activity. Derive the result class from test and sports class. Calculate the marks and 
