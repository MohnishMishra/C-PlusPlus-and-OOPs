// Create a class which stores name, author and price of
// a book. Store information for n
// number of books. Display information of all the books in a
// given price range using
// friend function.
